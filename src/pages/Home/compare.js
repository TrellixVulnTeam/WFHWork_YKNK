...
const Index = () => {
  ...
  const { trendingAllCategories_Action, search_trading_onClick_search_Action } =
    Actions;
  const [modelOpen, setModelOpen] = useState(false);
  const { ref, isComponentVisible, setIsComponentVisible } =
    useComponentVisibleHook(true);
  const { trendingCategories, searchingTradie, userData } = useSelector(
    ...
    <div>
      ...
      <section className="section">
        ...
        <div className="trending-services">
          <a href="#" className="trending-services__item">
            <div>
